        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
                    ...
                    m_LowAccel.volume = lowFade*accFade / 4.0f;
					m_LowDecel.volume = lowFade*decFade / 4.0f;
					m_HighAccel.volume = highFade*accFade / 4.0f;
					m_HighDecel.volume = highFade*decFade / 4.0f;
